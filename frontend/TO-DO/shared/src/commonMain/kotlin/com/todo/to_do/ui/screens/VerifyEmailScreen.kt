...
import com.todo.to_do.presentation.verifyemail.VerifyEmailSideEffect
...
fun VerifyEmailScreen(
    ...
    viewModel.collectSideEffect { effect ->
        when (effect) {
            VerifyEmailSideEffect.Verified -> onVerified()
            is VerifyEmailSideEffect.ShowError -> toastState.show(effect.message, isError = true)
            is VerifyEmailSideEffect.CodeResent -> toastState.show(effect.message)
        }
    }
